...
3. **Confirm the config is LIVE before any device ever runs** — use the API script, which encodes the cache-bust and poll-ordering quirks (prefer the OneSignal MCP if connected — after the app-match precondition in the Step 4 notes below):
